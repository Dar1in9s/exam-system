...
function selectquestions(o, d, n) {          // 题目已答
	var d = $('#' + d);
	var n = $('#' + n);
	if (d.val() == '') d.val(',');
	if ($(o).is(':checked')) {
...
function submitAjax(parms) {
	...
	$.ajax({
		...
		"success": function (data) {
			...
			catch (e) { console.log("parseJson error"); }
			finally {
				if (tmp) {
					data = tmp;
					$.zoombox.hide();
